...
gds.file <- "Annuus.tranche90.snp.gwas.90.bi.remappedHa412HO.gds"
vcf.file <- "Annuus.tranche90.snp.gwas.90.bi.remappedHa412HO.vcf.gz"
...
write(pca$eigenval, "PCA/Annuus.tranche90.snp.gwas.90.bi.remappedHa412HO.ldr0p2.eigenvalues.txt",
      ncol=length(pca$eigenval))


write.table(pca$eigenvect, "PCA/Annuus.tranche90.snp.gwas.90.bi.remappedHa412HO.ldr0p2.eigenvectors.txt",
...
gds.file <- "Annuus.tranche90.snp.gwas.90.bi.remappedHa412HO.v3noinv.ldfilter.gds"
vcf.file <- "Annuus.tranche90.snp.gwas.90.bi.remappedHa412HO.v3noinv.ldfilter.vcf.gz"
...
#Write eigenvectors and eigenvalues
write(pca$eigenval, "Annuus.tranche90.snp.gwas.90.bi.remappedHa412HO.v3noinv.ldfilter.ldr0p2.eigenvalues.txt",
      ncol=length(pca$eigenval))


write.table(pca$eigenvect, "Annuus.tranche90.snp.gwas.90.bi.remappedHa412HO.v3noinv.ldfilter.ldr0p2.eigenvectors.txt",
            col.names = F,row.names = F
      )
...
#Plotting PCAs
pdf("Annuus.tranche90.snp.gwas.90.bi.remappedHa412HO.v3noinv.ldfilter.ldr0p2.pca.pdf",height=4,width=14)
for (i in seq(1,20,2)){
  j <- i +1
  tab <- data.frame(name = pca$sample.id,
                    EV1 = pca$eigenvect[,i],  
...
write_tsv(tab, "Annuus.tranche90.snp.gwas.90.bi.remappedHa412HO.v3noinv.ldfilter.ldr0p2.pca.txt")
