species="argophyllus";
capital_species="Argophyllus"
prefix="${capital_species}.tranche90.snp.gwas.90.bi.remappedHa412HO"
...
#        fi
	...
	/home/owens/bin/emmax-intel64 -v -d 3 -t $species/${prefix}.beagle -p /home/owens/bin/wild_gwas_2018/gwas/$species/${phenotype}.txt -k $species/${prefix}.beagle.aIBS.kinf -o $species/results/${prefix}.${phenotype}.beagle -c $species/${prefix}.ldr0p2.PC1-3.cov.txt
	#Run on inversions with inversion remove genome PCA and kinship
	echo "Running $species with INVERSIONS..."
	/home/owens/bin/emmax-intel64 -v -d 3 -t $species/$INV_file -p /home/owens/bin/wild_gwas_2018/gwas/$species/${phenotype}.txt -k $species/${prefix}.beagle.v3noinv.ldfilter.aIBS.kinf -o $species/results/${INV_file}.$phenotype -c $species/${prefix}.v3noinv.ldfilter.ldr0p2.PC1-3.cov.txt
	#Run on SNPs with inversion removed genome PCA and kinship
	echo "Running $species with INV CONTROLLED SNPS..."
	/home/owens/bin/emmax-intel64 -v -d 3 -t $species/${prefix}.beagle -p /home/owens/bin/wild_gwas_2018/gwas/$species/${phenotype}.txt -k $species/${prefix}.beagle.v3noinv.ldfilter.aIBS.kinf -o $species/results/${prefix}.${phenotype}.beagle.v3noinv.ldfilter -c $species/${prefix}.v3noinv.ldfilter.ldr0p2.PC1-3.cov.txt
	#Gzip the files
