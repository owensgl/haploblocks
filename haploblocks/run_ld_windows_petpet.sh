...
#Excluding PET_30
bcftools view -O v -r Ha412HOChr$chr $species.${prefix}.vcf.gz | vcftools --vcf - --remove PET_30.samplelist.txt --maf 0.05 --thin 100  -c --geno-r2 | perl /home/owens/bin/reformat/emerald2windowldcounts.pl | gzip >$species.${prefix}.thin100.maf5.noPET30.Chr${chr}.windows.ld.gz
