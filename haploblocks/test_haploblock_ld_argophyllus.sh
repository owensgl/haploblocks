...
samplelist="Argophyllus.tranche90.snp.gwas.90.bi.samplelist.txt"
vcf="Argophyllus.tranche90.snp.gwas.90.bi.remappedHa412HO.vcf.gz"
...
done < argophyllus.haploblockld.info
